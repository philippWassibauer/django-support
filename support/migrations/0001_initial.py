...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SupportQuestion'
        db.create_table('support_supportquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=180, null=True, blank=True)),
            ...
            ('accepted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accepted_tickets', null=True, to=orm['auth.User'])),
            ('closed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('support', ['SupportQuestion'])


    def backwards(self, orm):
        
        # Deleting model 'SupportQuestion'
        db.delete_table('support_supportquestion')
    ...
    models = {
        ...
        'support.supportquestion': {
            'Meta': {'object_name': 'SupportQuestion'},
